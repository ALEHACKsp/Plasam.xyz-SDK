...
{
public:
	virtual bool ShouldHitEntity(BaseEntity *pEntity, int contentsMask) = 0;
...
{
public:
	bool ShouldHitEntity(BaseEntity* pEntityHandle, int /*contentsMask*/)
	{
...
{
public:
	virtual int   GetPointContents(const Vector &vecAbsPosition, int contentsMask = MASK_ALL, BaseEntity** ppEntity = nullptr) = 0;
	virtual int   GetPointContents_WorldOnly(const Vector &vecAbsPosition, int contentsMask = MASK_ALL) = 0;
	virtual int   GetPointContents_Collideable(ICollideable *pCollide, const Vector &vecAbsPosition) = 0;
	virtual void  ClipRayToEntity(const Ray_t &ray, unsigned int fMask, BaseEntity *pEnt, CGameTrace *pTrace) = 0;
